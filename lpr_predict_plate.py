...
boxes4 = Conv2D(n_boxes * (class_count+1), feature_map_shape, strides=(1, 1), padding="same", kernel_initializer='he_normal', name='boxes4')(x)
...
encoder = SSDInputEncoder(input_shape[0], input_shape[1], class_count, clip_boxes=clip_boxes, two_boxes_for_ar1=False, 
                          aspect_ratios_global=[1.0], predictor_sizes=[feature_map_shape], min_scale=anchor_box_size, max_scale=anchor_box_size)
